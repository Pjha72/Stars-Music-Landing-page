...
const Experince = () => {
  return (
    <div className='experience flex flex-col items-center justify-start px-[5rem] bg-[#020917] h-[60rem] pt-[18rem] mt-[-10rem] relative z-[2] rounded-b-[5rem]'>
      ...
      {/* Heading */}
      <div className="haedline mt-7 flex flex-col items-center text-[2rem]">
      ...
      {/* feature */}
      <div className="feature flex items-center justify-around mt-[6rem]">
        <Feature icon="Group 2" title="For Live Music" />
        <Feature icon="music icon" title="For Daliy Music" />
